...
<body>
  ...
  <main class="content">
    ...
    <section class="portfolio">
      <div class="list-header">
        <h2>Portafolio</h2>
        <p id="portfolioEmpty" class="muted">Sin emprendimientos registrados.</p>
      </div>
    ...
    <article class="card">
      ...
      <div class="card-body">
        ...
        <div class="note">
          ...
          <a class="note-text link" data-field="link" href="#" target="_blank" rel="noopener"></a>
        </div>
        <div class="note">
        ...
        <div class="edit-panel" data-field="editPanel">
          ...
          <label class="field">
            ...
            <input type="url" data-field="editLink" placeholder="https://" />
          </label>
          <label class="field">
            <span>Observaciones</span>
